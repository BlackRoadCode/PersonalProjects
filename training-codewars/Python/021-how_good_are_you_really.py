...
def better_than_average(class_points, your_points):
    ...
    for score in range( len( class_points ) ):
        class_total += class_points[ score ]
    clas_average = class_total / len( class_points )
    
    return ( False if clas_average > your_points else True )
